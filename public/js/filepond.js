...
(function(global, factory) {
    ...
    var defaultOptions = {
        ...
        labelFileProcessingRevertError: ['Error durante la eliminación', Type.STRING],

        labelTapToCancel: ['pulsa para cancelar', Type.STRING],
        labelTapToRetry: ['pulsa para reintentar', Type.STRING],
        labelTapToUndo: ['pulsa para deshacer', Type.STRING],

        labelButtonRemoveItem: ['Eliminar', Type.STRING],
        labelButtonAbortItemLoad: ['Abortar', Type.STRING],
        labelButtonRetryItemLoad: ['Reintentar', Type.STRING],
        labelButtonAbortItemProcessing: ['Cancelar', Type.STRING],
        labelButtonUndoItemProcessing: ['Deshacer', Type.STRING],
        labelButtonRetryItemProcessing: ['Reintentar', Type.STRING],
